<template>
    <div class="router-container">
        <div class="action-bar">
            <div class="left">
                <el-button type="primary" icon="el-icon-plus" @click="handleCreateService">创建路由</el-button>
...
<script>
    import RouteDetail from '@/modules/cs/resource/networks-adm/router/detail'
    ...
    export default {
        ...
        methods: {
            ...
            dispatchOpenSidePage(){
                this.$emit('openSidePage',this.$options.components.RouteDetail, {}, false)
            },
            // openSidePage() {
            //     // this.showSidePage = true
            //     // this.$showSidePage(this.$options.components.DetailLayout)
            //     this.$refs.sidePageStack.openPage(this.$options.components.RouteDetail, {}, false)
            // }
        },
        mounted() {
        },
